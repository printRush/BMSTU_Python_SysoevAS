; ModuleID = "/home/printrush/PycharmProjects/bmstu_python/laboratory_work_13/v2.0/codegen.py"
...
entry:
  ...
  %".12" = bitcast [14 x i8]* @".str.9134" to i8*
...
@".str.9134" = internal constant [14 x i8] c"Hello, World!\00"
